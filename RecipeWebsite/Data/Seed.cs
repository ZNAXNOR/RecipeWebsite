            ...
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                if (!context.Collections.Any())
                {
                    context.Collections.AddRange(new List<Collection>()
                    {
                        new Collection()
                        {
                            Title = "Recipe Collection 1",
                            Image = "https://www.eatthis.com/wp-content/uploads/sites/4/2020/05/running.jpg?quality=82&strip=1&resize=640%2C360",
                            Description = "This is the description of the first Collection",
                            CollectionCategory = CollectionCategory.Breakfast
                         },

                        new Collection()
                        {
                            Title = "Recipe Collection 2",
                            Image = "https://www.eatthis.com/wp-content/uploads/sites/4/2020/05/running.jpg?quality=82&strip=1&resize=640%2C360",
                            Description = "This is the description of the second Collection",
                            CollectionCategory = CollectionCategory.Lunch                            
                        },

                        new Collection()
                        {
                            Title = "Recipe Collection 3",
                            Image = "https://www.eatthis.com/wp-content/uploads/sites/4/2020/05/running.jpg?quality=82&strip=1&resize=640%2C360",
                            Description = "This is the description of the third Collection",
                            CollectionCategory = CollectionCategory.Dinner
                        },

                        new Collection()
                        {
                            Title = "Recipe Collection 4",
                            Image = "https://www.eatthis.com/wp-content/uploads/sites/4/2020/05/running.jpg?quality=82&strip=1&resize=640%2C360",
                            Description = "This is the description of the fourth Collection",
